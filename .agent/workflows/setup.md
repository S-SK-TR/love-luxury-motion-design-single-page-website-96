...
- `CLAUDE.md` dosyasındaki `Love: Luxury Motion-Design Single Page Website`, `Love: Luxury Motion-Design Single Page Website — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
